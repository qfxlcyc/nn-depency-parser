...
# project_dir = "./"
data_dir = os.path.join(project_dir, "data_full")
...
flags.DEFINE_integer("dev_val_num_sentences", 30, "Num of sentences for evaluation on dev set")
flags.DEFINE_integer("test_val_num_sentences", 2400, "Num of sentences for evaluation on test set")
